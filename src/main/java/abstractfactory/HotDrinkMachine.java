...
public class HotDrinkMachine {
    ...
    public HotDrinkMachine() {
        ...
        for (AvailableDrink availableDrink : AvailableDrink.values()) {
            ...
            try {
                Class<?> factory = Class.forName("abstractfactory." + factoryName);
        ...
        Set<Class<? extends IHotDrinkFactory>> types = new Reflections("abstractfactory").getSubTypesOf(IHotDrinkFactory.class);
