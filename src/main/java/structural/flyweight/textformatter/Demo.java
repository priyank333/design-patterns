...
public class Demo {
    public static void main(String[] args) {
        // This approach will occupy more memory because of boolean array, but it will reduce the no of bold text memory
        FormattedText frmtedText = new FormattedText("i love winter");
        frmtedText.setRange(2, 5);
        System.out.println(frmtedText);
    }
}
