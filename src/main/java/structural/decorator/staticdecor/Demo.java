...
public class Demo {
    public static void main(String[] args) {
        Shape redColorShape = new ColorShape<>(() -> new Circle(1), "Red");
        Shape greenTransparentSquare = new ColorShape<>(() -> new TransparentShape(
                () -> new Square(8), 45.33f), "Green");
        System.out.println(redColorShape.info());
